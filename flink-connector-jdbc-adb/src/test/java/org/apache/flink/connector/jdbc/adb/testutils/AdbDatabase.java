...
/** ADB database for testing. */
public class AdbDatabase extends DatabaseExtension {

    public DatabaseMetadata getMetadata() {
        return new AdbMetadata();
    }
    ...
    protected DatabaseResource getResource() {
        return new AdbFakeResource();
    }

    /** Fake ADB resource. */
    public static class AdbFakeResource implements DatabaseResource {
